...
export default function TopupButton({
  ...
  return (
    <button
      className={cn(
        'flex h-10 w-full items-center whitespace-nowrap rounded-lg border-2 border-dashed border-gray-500 bg-gray-100 px-6 text-sm uppercase tracking-wider text-gray-900 dark:border-input-light-dark dark:bg-gray-400 dark:text-white lg:h-12 3xl:h-13',
        className
      )}
    >
