...
const TabSelect = forwardRef(
  (
    ...
    return (
      <div
        ref={selectRef}
        className="rounded-lg border-2 border-gray-200 dark:border-input-light-dark"
      >
        <button
        ...
        <div
          className={cn(
            'absolute left-0 top-full z-20 mt-1 grid w-full gap-0.5 rounded-lg border border-gray-200 bg-white p-2 text-left shadow-large dark:border-input-light-dark dark:bg-gray-400 xs:gap-1',
