    ...
    switch (variant) {
      ...
      case 'transparent':
        buttonColorClassNames = `${colorClassNames[0]} ${
          disabled || isLoading
            ? ''
            : 'hover:bg-gray-100 dark:hover:bg-input-light-dark focus:bg-gray-100 dark:focus:bg-input-light-dark'
        } `;
        buttonDripColor = 'rgba(0, 0, 0, 0.1)';
        break;
      ...
      <button
        ...
        className={cn(
          ...
          !disabled
            ...
            : 'cursor-not-allowed bg-brand/30 border-brand/30 text-gray-400',
