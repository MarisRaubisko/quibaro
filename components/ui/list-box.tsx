...
const listboxVariantClasses = {
  ghost:
    'transition-shadow border border-gray-200 bg-white text-gray-900 hover:border-gray-900 hover:ring-1 hover:ring-gray-900 dark:border-input-light-dark dark:bg-gray-400 dark:text-gray-100 dark:hover:border-gray-600 dark:hover:ring-gray-600',
  solid:
    'transition-colors bg-gray-100 hover:bg-gray-200/70 dark:bg-gray-400 dark:hover:bg-gray-700',
  transparent: '',
};
    ...
    <div className={cn('relative', className)}>
      <HeadlessListbox value={selectedOption} onChange={onChange}>
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <HeadlessListbox.Options className="absolute left-0 z-10 mt-1 grid w-full origin-top-right gap-0.5 rounded-lg border border-gray-200 bg-white p-1 shadow-large outline-none dark:border-input-light-dark dark:bg-gray-400 xs:p-2">
            {options.map((option) => (
