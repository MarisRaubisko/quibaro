...
function Upload(
  ...
  return (
    <div
      className={cn(
        "rounded-lg border border-solid border-gray-200 bg-white p-4 dark:border-input-light-dark dark:bg-light-dark sm:p-6",
        wrapperClassName
      )}
    >
      <div
        className="border border-dashed relative border-gray-200 dark:border-input-light-dark h-48 flex items-center justify-center rounded-lg"
        {...dropzoneRootProps}
      >
        <input
          ref={ref}
        ...
        {placeholderText || (
          <div className="text-center">
            <p className="mb-6 text-sm tracking-tighter text-gray-600 dark:text-gray-400">
              {placeholderText || "PNG, JPG, JPEG or WEBP. Max 10mb."}
            </p>
